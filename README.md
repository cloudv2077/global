...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/global)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/global
```

A live public deployment of this template is available at [https://global.templates.workers.dev](https://global.templates.workers.dev)
